...
public class PetersonProgramGraphBuilder {
	 ...
	 */
	public static ProgramGraph<Object, Object> build(int id) {
		ProgramGraph<Object, Object> pg = FvmFacade.get().createProgramGraph();
	 ...
	 * @return A program graph representing the process with the given id
	 */
	public static ProgramGraph<Object, Object> build2(int id) {
		ProgramGraph<Object, Object> pg = FvmFacade.get().createProgramGraph();
